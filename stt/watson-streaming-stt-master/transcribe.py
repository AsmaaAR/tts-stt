...
apikey ='AYuFtVPMw6HS9MRp1NVZCnYdyeLQrZSCh_1zc2q8E5LQ'
url = 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/dfcc76c3-8ba3-4d31-bd00-9b42373eb5aa'
# Setup Service
...
def read_audio(ws, timeout):
    ...
    with open('./txt.mp3', 'wb') as audio_file:
...
def on_message(self, msg):
    ...
    if "results" in data:
        ...
        print(p)
        with open('ayaudio.txt','w') as out:
            out.writelines(p)
